...
function t9() {
    ...
    let out = ' ';
    if ( i91 < i92) {
        for (let a = i91; a <= i92; a++) {
            out += a + ' '; 
        } 
        } else if (i91 > i92) {
            for (let a = i92; a <= i91; a++) {
                out += a + ' ';
            }            
        }
...
function t11() {
    ...
    out = '';
    for (let a = 0; a < div11.length; a++) {
       out += div11[a].innerHTML + ' ';
    }
...
function t12() {
    ...
    for (let a = 0; a < div12.length; a++) {
        div12[a].style.background = 'orange';
    }
}
