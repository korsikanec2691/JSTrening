...
document.querySelector('.three').innerHTML = '<h3>Lorem ipsum dolor sit amet consectetur adipisicing.</h3>';
...
document.querySelector('.four').innerHTML = '<h3>Lorem ipsum</h3>';
document.querySelector('.four').innerHTML += '<p>Lorem ipsum dolor sit amet consectetur adipisicing</p>'
