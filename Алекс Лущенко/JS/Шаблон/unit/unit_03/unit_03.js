...
let is8 = document.querySelector('.s-8');
...
let is10 = document.querySelector('.s-100');
...
let is11 = document.querySelector('.s-110');
...
let i13 = document.querySelector('.i-130');
...
// любое значение введенное в input JS воспринемет как строка. Для того что бы изменить тип данных нужно перед значением value поставить знак +;
...
let s14 = document.querySelector('.s-143');
...
let is151 = document.querySelector('.s-151');
let is152 = document.querySelector('.s-152');
let is153 = document.querySelector('.s-153');
