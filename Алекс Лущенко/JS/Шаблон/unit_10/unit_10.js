...
//Создайте массив ar1 содержащий строки, числа, булевы значения. Выведите его в .out-1. Вывод - по нажатию кнопки b-1
    ...
    let ar1 = ['Yamen gehbe', 27, true, false];
...
//Создайте массив ar2 содержащий строки, числа, булевы значения. Выведите его в div.out-2. Используйте шаблон вывода из кода в JS. Вывод - по нажатию кнопки b-2
    ...
    let ar2 = ['Yamen', 'sik emen', true, 27];
...
let ar4 = [1,2,3,4,5,'yamen',true,8,10]
...
let ar5 = [1,0,0,4,5,6,7,8,9,20,30];
// let ar5 =
function f5() {
    let sum = 0
    ...
    let out = document.querySelector('.out-5');
     ...
     out.innerHTML = sum + ar5[0] +  ar5[2] +  ar5[3];
}
...
let ar6 = ['Ровшан','стрелец',26,11];
// let ar6 =

function f6() {
    let out = document.querySelector('.out-6');
    out.innerHTML = ar6[0] + ' ' + ar6[1] + ' ' + ar6[2] + ' ' + ar6[3];
}
...
function f7() {
    let out = ar7[0] + ' ' + ar7[1] + ' ' + ar7[2] + ' ' + ar7[3] + ' ' + ar7[4] + ' ' + ar7[5] + ' ' + ar7[6] + ' ' + ar7[7];
