...
function f3() {
    // alert(document.querySelector('.p-3').innerHTML = 'Task 3');let
}
...
function f7() {
    ...
    document.querySelector('.out-71').innerHTML = a.value;
    let f = a.value;
          if (f.length > 5) {
...
function f8() {
    ...
    out.innerHTML += '<button class="b-81">Goo</button>';
    let btn81 = document.querySelector('.b-81').onclick = f81;
}
...
let inRadio = document.querySelector('.r-9');
    if (inRadio.checked) {
        out.innerHTML = inRadio.value;
    } else {
        out.innerHTML = 0;
    }
}
...
function f10() {
    ...
    out.style.backgroundColor = i10.value;
}
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = i191.value;
    document.querySelector('.out-19').innerHTML += ' ';
    document.querySelector('.out-19').innerHTML += i192.value;
...
function f20(e) {
    ...
    document.querySelector('.out-20').innerHTML = user;
    document.querySelector('.out-20').innerHTML += ' ';
    document.querySelector('.out-20').innerHTML += pass;
}
